...
class SignupBottom extends Component{
    ...
    checkAll = () => {
        if(this.state.isAllSelected){
            this.setState({zero : true, one : true, two : true, three : true, four : true, five : true, six : true},()=>{this.checkBtn()})
        }else if(this.state.isAllUnSelected){
            this.setState({zero : false, one : false, two : false, three : false, four : false, five : false, six : false},()=>{this.checkBtn()})
        }
    }
    checkBtn = () => {
                ...
                <div className = { this.state.view }>
                    <div className = "agreement_info">
                        <p className = "info_text">
                            아래 모든 약관 (필수/선택 포함) 및 광고성 정보수신 동의 내용을 확인하고 전체 동의합니다. ※ 선택 항목에 대한 동의를 거부하더라도 회원가입에 영향을 미치지 않습니다.
                        </p>
                    </div>
                    <div className = "account_check">
                        <span className="title">아모레퍼시픽 통합 멤버십 뷰티포인트 회원약관</span>
                        <ul>
                            <li>
                                <button onClick={() => this.changeShape("one")} type="checkbox" className="checkbox">
                            ...
                            <li>
                                <button onClick={() => this.changeShape("two")}type="checkbox" className="checkbox">
                            ...
                            <li>
                                <button onClick={() => this.changeShape("three")} type="checkbox" className="checkbox">
                            ...
                            <li>
                                <button onClick={() => this.changeShape("four")}type="checkbox" className="checkbox" >
                    ...
                    <div className = "ad_check">
                        ...
                        <ul>
                            <li>
                                <button onClick={() => this.changeShape("five")} type="checkbox" className="checkbox">
                                    <img src={this.state.five === false ? click : clicked }/>
                                </button>
                                <span>[선택] 뷰티포인트 문자 수신 동의</span>
                            </li>
                            <li>
                                <button onClick={() => this.changeShape("six")} type="checkbox" className="checkbox">
                    ...
                    <p className = "info_text">
                        ※ 아모레퍼시픽은 서비스 향상 및 원활한 전산 처리 등을 위하여 이용자의 개인정보 관리를 외부 전문업체에 위탁하고 있습니다. 아모레퍼시픽의 업무를 위탁받는 자 및 업무의 내용은 아모레퍼시픽 홈페이지 <strong>https://www.beautypoint.co.kr/footer/privacy/personal.html</strong> 에서 확인 하실 수 있습니다.
                    </p>
                </div>
                </div>
