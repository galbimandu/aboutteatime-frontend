...
class Nav extends Component {
  ...
  enter_shop = () => {
    this.setState({ hover: "menu_hide_container_active", onmouse_shop: "idx0_list2", color_shop: "idx0_1"})
  }
  ...
  enter_tealife = () => {
    this.setState({ hover: "menu_hide_container_active", onmouse_tealife: "idx1_list2", color_tealife: "idx1_1", sub_tea_hover: "sub_menu_tea_container", sub_teaware_hover: "sub_menu_teaware_container" })
  }
  ...
  enter_event = () => {
    this.setState({ hover: "menu_hide_container_active", onmouse_event: "idx2_list2", color_event: "idx2_1", sub_tea_hover: "sub_menu_tea_container", sub_teaware_hover: "sub_menu_teaware_container" })
  }
  ...
  enter_about = () => {
    this.setState({ hover: "menu_hide_container_active", onmouse_about: "idx3_list2", color_about: "idx3_1", sub_tea_hover: "sub_menu_tea_container", sub_teaware_hover: "sub_menu_teaware_container" })
  }
  ...
  enter_jeju = () => {
    this.setState({ hover: "menu_hide_container_active", onmouse_jeju: "idx4_list2", color_jeju: "idx4_1", sub_tea_hover: "sub_menu_tea_container", sub_teaware_hover: "sub_menu_teaware_container" })
  }
  ...
  enter_teashop = () => {
    this.setState({ sub_tea_hover: "sub_menu_tea_container_active", sub_teaware_hover: "sub_menu_teaware_container"})
  }
  ...
  leave_sub = () => {
    this.setState({ sub_tea_hover: "sub_menu_tea_container", sub_teaware_hover: "sub_menu_teaware_container"})
  }

// mouse leave 초기화
  menu_leave = () => {
    this.setState({ hover: "menu_hide_container",
    onmouse_shop: "idx0_list",
    onmouse_tealife: "idx1_list",
    onmouse_event: "idx2_list",
    onmouse_about: "idx3_list",
      ...
      <div className="Nav" onMouseLeave={this.menu_leave}>
          ...
          <div className="header_top">
            ...
            <div className="buttons">
              <div className="login_wrap">
                <div className="login" onClick={this.goto_login}>로그인</div>
              </div>
          ...
          <div className="header_bottom">
            <ul className="menu_wrap">
              <li className="idx0_wrap" onMouseLeave={this.leave_shop}>
                <div className={this.state.color_shop} onMouseEnter={this.enter_shop}>Shop</div>
              </li>
              <li className="idx1_wrap" onMouseLeave={this.leave_tealife}>
                <div className={this.state.color_tealife} onMouseEnter={this.enter_tealife}>Tea Life</div>
              </li>
              <li className="idx2_wrap" onMouseLeave={this.leave_event}>
                <div className={this.state.color_event} onMouseEnter={this.enter_event}>Event</div>
              </li>
              <li className="idx3_wrap" onMouseLeave={this.leave_about}>
                <div className={this.state.color_about} onMouseEnter={this.enter_about}>About OSULLOC</div>
              </li>
              <li className="idx4_wrap" onMouseLeave={this.leave_jeju}>
                <div className={this.state.color_jeju} onMouseEnter={this.enter_jeju}>Jeju Tea Museum</div>
              </li>
            </ul>
        ...
        <div className={this.state.hover}>
          ...
          <div className="menu_hide_wrap">
            {/* idx0_list */}
            <ul className={this.state.onmouse_shop} onMouseEnter={this.enter_shop} onMouseLeave={this.leave_shop}>
            ...
            <ul className={this.state.onmouse_tealife} onMouseEnter={this.enter_tealife} onMouseLeave={this.leave_tealife}>

              <li className="idx1_list_detail">
                상품 구매후기
              </li>
              <li className="idx1_list_detail">
                선물하기
            ...
            <ul className={this.state.onmouse_event} onMouseEnter={this.enter_event} onMouseLeave={this.leave_event}>
            ...
            <ul className={this.state.onmouse_about} onMouseEnter={this.enter_about} onMouseLeave={this.leave_about}>
            ...
            <ul className={this.state.onmouse_jeju} onMouseEnter={this.enter_jeju} onMouseLeave={this.leave_jeju}>
