...
class Nav extends Component {
  ...
  enter_tealife = () => {
    this.setState({ hover: true, onmouse_tealife: true, color_tealife: true, sub_tea_hover: false, sub_teaware_hover: false })
  }
  ...
  enter_event = () => {
    this.setState({ hover: true, onmouse_event: true, color_event: true, sub_tea_hover: false, sub_teaware_hover: false })
  }
  ...
  enter_about = () => {
    this.setState({ hover: true, onmouse_about: true, color_about: true, sub_tea_hover: false, sub_teaware_hover: false })
  }
  ...
  enter_jeju = () => {
    this.setState({ hover: true, onmouse_jeju: true, color_jeju: true, sub_tea_hover: false, sub_teaware_hover: false })
  }
      ...
      <div className="Nav" onMouseLeave={this.menu_leave}>
          ...
          <div className="header_bottom">
            <ul className="menu_wrap">
              <li className="idx0_wrap" onMouseLeave={this.leave_shop}>
                <div className={ color_shop ? "idx0_1" : "idx0" } onMouseEnter={this.enter_shop}>Shop</div>
              </li>
              <li className="idx1_wrap" onMouseLeave={this.leave_tealife}>
                <div className={color_tealife ? "idx1_1" : "idx1" } onMouseEnter={this.enter_tealife}>Tea Life</div>
              </li>
              <li className="idx2_wrap" onMouseLeave={this.leave_event}>
                <div className={ color_event ? "idx2_1" : "idx2" } onMouseEnter={this.enter_event}>Event</div>
              </li>
              <li className="idx3_wrap" onMouseLeave={this.leave_about}>
                <div className={ color_about ? "idx3_1" : "idx3" } onMouseEnter={this.enter_about}>About OSULLOC</div>
              </li>
              <li className="idx4_wrap" onMouseLeave={this.leave_jeju}>
                <div className={ color_jeju ? "idx4_1" : "idx4" } onMouseEnter={this.enter_jeju}>Jeju Tea Museum</div>
              </li>
            </ul>
        ...
        <div className={ hover ? "menu_hide_container_active": "menu_hide_container" }>
          ...
          <div className="menu_hide_wrap">
            ...
            <ul className={ onmouse_tealife ? "idx1_list2" : "idx1_list" } onMouseEnter={this.enter_tealife} onMouseLeave={this.leave_tealife}>
            ...
            <ul className={ onmouse_event ? "idx2_list2" : "idx2_list" } onMouseEnter={this.enter_event} onMouseLeave={this.leave_event}>
