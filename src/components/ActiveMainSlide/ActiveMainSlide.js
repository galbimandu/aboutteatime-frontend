    ...
    return (
      <div className="activeMainSlide">
        ...
        <section className="brandStory part1">
          <span className="brandStoryTitle">일구다</span>
          <span className="brandStorySubTitle">아름다운 집념</span>
          <span className="brandStoryContent">
            “ 어느 나라를 가도 나라마다 독특한 차가 하나씩은 있는데 우리나라는
            없다. 어떤 희생을 치르더라도 우리의 전통 차문화를 정립하고 싶다.
          </span>
          <span className="from">- 아모레퍼시픽 창업자 故 서성환 회장”</span>
          <span className="brandStorySubTitle">제주와의 인연</span>
          <span className="brandStoryContent">
        ...
        <section className="brandStory part2">
          <span className="brandStoryTitle">가꾸다</span>
          <span className="brandStorySubTitle">
          ...
          <span className="brandStorySubTitle">제주의 자연으로 빚은 발효</span>
          <span className="brandStoryContent">
        ...
        <section className="brandStory part3">
          <span className="brandStoryTitle">즐기다</span>
          <span className="brandStorySubTitle">
            차와 제주가 선사하는 <br />
            삶의 아름다움
          </span>
