...
import NavMove from "../NavMove/NavMove";
...
class Basket extends Component {
  ...
  render() {
    const basket_feeds = this.state.feeds_arr.map((element, i) => {
      return (
        <BasketFeeds
          handleData={this.getData}
          cart_id={element.cart_id}
          id={element.id}
          feeds_arr={this.state.feeds_arr}
          price_arr={this.state.price_arr}
          empty_feed={this.state.empty_feed}
          title={element.title}
          price={element.price}
          image={element.image}
          ...
          checkbox_each={this.state.checkbox_each}
          checkbox_each_checked={this.checkbox_each_checked}
          num={this.state.num}
          key={i}
        />
      );
          ...
          <main className="main_container">
            <section className="section_wrap">
              <header className="basic_header">
                <h1 className="header_text">장바구니</h1>
              </header>
                ...
                <div className="form">
                    ...
                    <div className="order_table_wrap">
                      <table className="order_table">
                          ...
                          <tr>
                            <th className="t_check">
                              <div
                                className={
                                  checkbox_all
                                    ? "checkbox_wrap_checked"
                                    : "checkbox_wrap"
                                }
                                onClick={this.checkbox_all_checked}
                              >
                                <input
                                  className="checkbox"
                                  type="checkbox"
                            ...
                            <th className="t_info">상품정보</th>
                            <th className="t_qty">수량</th>
                            <th className="t_price">
                              <div className="t_price_text">상품가격</div>
                            </th>
                            <th className="t_selling_price">
                              <div className="t_selling_price_text">
                                판매가격
                              </div>
                            </th>
                        ...
                        <tbody>
                          ...
                          <tr
                            className={
                              empty_feed ? "empty_body" : "empty_body_active"
                            }
                          >
                            <td colSpan="6">
                              장바구니에 담긴 상품이 없습니다.
                  ...
                  <div className="tab_footer_container">
                    <div className="tab_footer_wrap">
                      <button className="order_checked">선택상품 주문</button>
                      <button className="order_all">전체상품 주문</button>
                    </div>
                  </div>
                </div>
              </section>
