...
class SignupTop extends Component {
  ...
  male_checked = () => {
    this.setState({
      male_active: "gender_male_wrap2",
      female_active: "gender_female_wrap",
    });
  ...
  auto_checked = () => {
    this.setState({
      direct_active: "select_password_direct2",
      auto_active: "select_password_auto",
      direct_check: check_toclick,
      auto_check: check_clicked,
        ...
        <div className="content">
          <h2>
            <strong className="welcome">
              뷰티포인트 통합멤버십 회원가입을 환영합니다!
            </strong>
            <p>
              아모레퍼시픽 통합멤버십(뷰티포인트)에 가입하시면{" "}
              <strong className="brand">오설록 쇼핑몰</strong> 외 모든 브랜드
              온/오프 매장에서 상품을 구매 할 때마다 현금처럼 사용할 수 있는
        ...
        <div className="join_table">
          ...
          <div className="birth_gender_wrap">
            ...
            <ul className="gender_wrap">
              <li
                className={this.state.male_active}
                onClick={this.male_checked}
              >
                <p className="gender_male" name="gender">
                  남자
                </p>
                <img className="check_img" src={check_img} alt="check_img" />
              </li>
              <li
                className={this.state.female_active}
                onClick={this.female_checked}
              >
                <p className="gender_female" name="gender">
                  여자
                </p>
                <img className="check_img" src={check_img} alt="check_img" />
              </li>
          ...
          <div className="user_id_wrap">
            <p className="description">
              * 아이디 미입력 시 휴대폰번호로 가입되며 가입완료 후 변경
              불가합니다.
            </p>
          </div>
          ...
          <div className="select_password_wrap">
            <div
              className={this.state.direct_active}
              onClick={this.direct_checked}
            >
              <div className="password_img">
                <img
                  className="check_toclick"
                  src={this.state.direct_check}
                  alt="check_clicked"
                />
              </div>
          ...
          <div className={this.state.hide_password}>
            <div className="input_password">
              <span className={this.state.password_notice}>
                비밀번호는 영문 대문자, 소문자, 숫자, 특수문자 중 최소 2가지
              ...
              <input
                ...
                autoCapitalize="off"
                placeholder="비밀번호는 (6~16자)"
              ></input>
            </div>
            <div className="confirm_password">
              <span className={this.state.confirm_password_notice}>
                비밀번호 확인을 입력하세요.
              </span>
              <input
                onChange={this.confirm_password_notice_off}
                onClick={this.confirm_password_notice}
                id="confirm_password"
